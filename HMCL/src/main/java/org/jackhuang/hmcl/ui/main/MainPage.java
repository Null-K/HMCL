...
public final class MainPage extends StackPane implements DecoratorPage {
...

    {
        ...
        //if (!Objects.equals(Metadata.VERSION, config().getShownTips().get(ANNOUNCEMENT))) {
        //    String title = "修改版提示";
        //    String content = "你正在使用 TerryPhil HMCL 修改版。修改版功能未受充分验证，使用起来可能不稳定！" +
        //            "\n如果在使用过程中遇到问题，请尝试下载 <a href=\"https://hmcl.huangyuhui.net/download\">官方版</a> 进行替换使用。" +
        //            "\n\n在游戏中遇到问题，你可以点击启动器右上角问号图标，加入官方群进行反馈。";
//
